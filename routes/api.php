...
Route::post('list_deliveries','api\DeliveriesController@index')->middleware('auth:api');
...
//Special_Permissions
Route::post('list_special_permissions','api\Special_PermissionsController@index')->middleware('auth:api');
